...
// Section Components - using shared components from leader folder
...
import FeedbackSurvey from "@/components/knowledge-assessment-leader/FeedbackSurvey";
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg transition-colors">
      ...
      <div className="ml-0 lg:ml-[245px] transition-all duration-300">
        <Header
          ...
          pageTitle="Assessment & Evaluation"
