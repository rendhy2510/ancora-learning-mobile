    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        <div className="flex items-center gap-1">
          ...
          >
            <svg
              className={`w-3 h-3 ${trend === "up" ? "" : "transform rotate-180"}`}
              fill="#2848A5"
              stroke="#2848A5"
              viewBox="0 0 24 24"
            >
...
export default HCAnalyticsStats;
