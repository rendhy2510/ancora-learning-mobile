...
const LeaderDashboardStats = () => {
  const stats = [
    {
      title: "Team Members Enrolled",
      value: 45,
      change: "+10",
      changeType: "increase" as const,
      icon: "fluent_people-team-20-filled",
    },
    {
    ...
    {
      title: "Team Certificates Earned",
      value: 20,
      change: "+12",
      changeType: "increase" as const,
...
export default LeaderDashboardStats;
