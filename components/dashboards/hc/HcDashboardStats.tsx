    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        <div className="flex items-center gap-1">
          <div className="w-5 h-5 rounded-full border border-[#2848A5] bg-[#DEEAFB] flex items-center justify-center text-blue-500">
            <svg
...
const HcDashboardStats = () => {
  const stats: StatCardProps[] = [
    ...
    },
    {
      ...
      change: "+8",
      changeType: "increase",
      icon: "icon-park-solid_check-one",
    },
    {
...
export default HcDashboardStats;
