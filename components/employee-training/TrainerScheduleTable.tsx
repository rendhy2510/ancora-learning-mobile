  ...
  const data = [
    {
      ...
      no: "01",
      name: "Kristin Watson",
      session: "AI Fundamentals Workshop",
      date: "March 5, 2024",
      time: "9:00 AM - 12:00 PM",
      location: "Company HQ, Jakarta",
    ...
    },
    {
      ...
      no: "02",
      name: "Bessie Cooper",
      session: "Advanced Machine Learning Techniques",
      date: "March 6, 2024",
    ...
    },
    {
      ...
      session: "Data Visualization Best Practices",
      date: "March 7, 2024",
  ...
  return (
    ...
    >
      ...
      <CardBody className="p-0 overflow-x-auto">
        <Table
          removeWrapper
          aria-label="Trainer Schedule Table"
          classNames={{
          ...
          <TableBody>
            {data.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell className="font-geist">{row.date}</TableCell>
                <TableCell className="font-geist">{row.time}</TableCell>
