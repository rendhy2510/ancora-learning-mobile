    ...
    <>
      ...
      >
        <CardHeader className="flex items-center justify-between border-b border-gray-100 dark:border-dark-border !w-auto">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 flex items-center justify-center rounded-lg bg-white dark:bg-dark-navy border border-gray-100 dark:border-dark-border text-[#2848A5]">
              <SvgIcon name="ph_video-conference-fill-blue" />
            </div>
        ...
        <CardBody className="p-0 overflow-x-auto">
          <Table
            removeWrapper
            aria-label="Mandatory Events Table"
            classNames={{
              ...
              td: "text-[14px] text-gray-600 dark:text-gray-400 font-medium py-3 border-b border-gray-50 dark:border-dark-border/50",
            }}
          >
            <TableHeader>
      ...
      <EventSchedulingModal isOpen={isOpen} onOpenChange={onOpenChange} />
    </>
  );
};

export default MandatoryEventsTable;
